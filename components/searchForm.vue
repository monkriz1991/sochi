  ...
  export default {
    ...
    data(){
      return {
        ...
        placeOptions: [],
        places: [],
        start_date: this.$assets.genNowSpec(5),
        end_date: this.$assets.genNowSpec(12),
        carClass: 5,
        carClassOption: [
    ...
    mounted() {
      ...
      this.start_date = this.$route.query.df ? this.$route.query.df.replace(' 03:00', '+03:00') : this.$assets.genNowSpec(5);
      this.end_date = this.$route.query.dt ? this.$route.query.dt.replace(' 03:00', '+03:00') : this.$assets.genNowSpec(12);
