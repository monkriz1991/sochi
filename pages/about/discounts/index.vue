  ...
  export default {
    head () {
      return {
        ...
        meta: [
          {hid: 'description', name: 'description', content: 'Дополнительные скидки на аренду авто в Сочи  до 25%: ✮ без ограничения пробега ✮ 250 машин в автопарке ✮ бесплатная подача в аэропорт ✮ Бронируй онлайн!⭐'}
        ]
      }
    },
    components: {
