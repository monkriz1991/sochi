  ...
  export default {
    head () {
      return {
        ...
        meta: [
          {hid: 'description', name: 'description', content: 'Новости и полезная информация о Крыме: ✮ узнайте все о достопримечательностях Крыма ✮ самых вкусных местах ✮ и как успеть все посмотреть с помощью Sochi Rent-a-Car⭐'}
        ]
      }
    },
    components: {
