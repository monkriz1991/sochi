  ...
  export default {
    head () {
      return {
        ...
        meta: [
          {hid: 'description', name: 'description', content: 'Цены на аренду авто в Сочи: ✮ без ограничения пробега ✮ скидки до 25% ✮ 250 машин в автопарке ✮ бесплатная подача в аэропорт ✮ Бронируй онлайн!⭐'}
        ]
      }
    },
    name: "prices",
