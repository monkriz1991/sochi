      ...
      main.py-3
        div.container
          ...
          div(v-if="$i18n.locale === 'ru'")
            ...
            p="для оформления заказа вам нужно иметь при себе только паспорт, водительское удостоверение и залоговую сумму;"
            ...
            p="Обратите внимание и на то, что если вы решили взять микроавтобус в аренду без водителя, вносить залоговую сумму вы можете непосредственно при получении авто в пользование. Мы не требуем от вас предоплаты за те услуги, которые, по факту, вы еще не получили."
