                ...
                div.info_part.mt-2
                  ...
                  div(v-if="!car_data.special_price")
                    div(v-if="!no_limit_avalible")
                      div(v-if="!['промо', 'promo', 'Промо', 'ПРОМО', 'Promo', 'PROMO', 'Электросамокаты', 'электросамокаты', 'Электросамокат', 'электросамокат'].includes(car_data.klassavtomobilya)").p-3.info-inside.wbb
                        h4="{{$t('bocid12')}}"
                        b-form-group
                          b-row
